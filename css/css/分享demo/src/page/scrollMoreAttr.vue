...
<style lang="less">
  ...
  .wrapper > div::selection, .wrapper > div div::selection {
  ...
  ::-webkit-scrollbar-corner:window-inactive {
    background-image: url("./../assets/images/corner-inactive.png");
  }
  ...
  ::-webkit-resizer:window-inactive {
    /*background-image: url("./../assets/images/resize-inactive.png");*/
    background: blue;
  }
